...
export const metadata: Metadata = {
    title: "Terms & Condition | Optura Agency by Get NextJs Templates",
};

export default function Page() {
    return (
        <main className="pt-44 2xl:pb-20 pb-10">
            <section className="relative before:absolute before:w-full before:h-3/4 before:bg-linear-to-r before:from-cyan-gradient before:via-white before:to-purple-gradient before:rounded-full before:top-24 before:blur-3xl before:-z-10 dark:before:from-dark-cyan-gradient dark:before:via-black dark:before:to-dark-purple-gradient dark:before:blur-3xl dark:before:-z-10">
