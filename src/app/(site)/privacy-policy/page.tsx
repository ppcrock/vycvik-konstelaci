...
export const metadata: Metadata = {
    title: "Privacy Policy | Optura Agency by Get NextJs Templates",
};

export default function Page() {
    return (
        <main className="pt-44 2xl:pb-20 pb-10">
            <section className="w-full ">
                <div className="relative before:absolute before:w-full before:h-3/4 before:bg-linear-to-r before:from-cyan-gradient before:via-white before:to-purple-gradient before:rounded-full before:top-24 before:blur-3xl before:-z-10 dark:before:from-dark-cyan-gradient dark:before:via-black dark:before:to-dark-purple-gradient dark:before:blur-3xl dark:before:-z-10">
                            ...
                            <div className="bg-white dark:bg-dark p-8 rounded-2xl">
                                ...
                                <div className="my-6">
                                    ...
                                    <p className="mt-6 text-opacity-60">
                                        ...
                                        <Link href="https://getnextjstemplates.com/" className="text-dark hover:text-primary">(https://getnextjstemplates.com/)</Link>. We refer to their Privacy Statement <Link href="https://getnextjstemplates.com/" className="text-dark hover:text-primary">(https://getnextjstemplates.com/)</Link>.
                                    </p>
                                ...
                                <div className="my-6">
                                    ...
                                    <p className="mt-6 text-opacity-60">
                                        ...
                                        <Link href="https://www.paddle.com/" className="text-dark hover:text-primary">(https://getnextjstemplates.com)</Link>. We refer to their Privacy Statement <Link href="https://www.paddle.com/" className="text-dark hover:text-primary">https://getnextjstemplates.com/</Link>.
                                    </p>
                                </div>
                            </div>
                        </div>
