  ...
  return (
    <>
      <div id='version' className='md:scroll-m-[180px] scroll-m-28'>
        ...
        <div className='w-full flex justify-between gap-0 lg:flex-nowrap flex-wrap p-6 rounded-md border border-dark/10 dark:border-white/10'>
          {PackageVersions &&
            PackageVersions.map((item) => {
              return (
                <div
                  key={item.id}
                  className='lg:w-1/5 md:w-full text-center lg:border-b-0 border-b lg:border-e lg:last:border-e-0 last:border-b-0 border-dark/10 dark:border-white/10'>
                  <Image
                    src={item.img}
                    alt='npm-package'
                    width={40}
        ...
        <div className='mt-5'>
          <p className='text-base font-medium text-midnight_text dark:text-grey'>
            Optura Tailwind NextJs Template is built with Tailwindcss and Nextjs.
          </p>
          <p className='text-base font-medium text-midnight_text dark:text-grey'>
          ...
          <p className='text-base font-medium text-midnight_text dark:text-grey'>
            ...
            Tailwind and TSX to be able to modify these template.
          </p>
        </div>
      </div>

      <div
        className={`lg:hidden block fixed top-0 right-0 h-full w-full bg-white dark:bg-darkmode shadow-lg transform transition-transform duration-300 max-w-xs ${docNavbarOpen ? 'translate-x-0' : 'translate-x-full'
          } z-50`}>
