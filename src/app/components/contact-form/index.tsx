  ...
  return (
    <section className='relative'>
      <div className=' w-full pt-44 2xl:pb-20 pb-10'>
        <div className="relative before:absolute before:h-full before:w-full before:bg-linear-to-r before:from-cyan-gradient before:via-white before:to-purple-gradient dark:before:from-dark-cyan-gradient dark:before:via-black dark:before:to-dark-purple-gradient dark:before:rounded-full dark:before:blur-3xl dark:before:-z-10 before:rounded-full before:top-24 before:blur-3xl before:-z-10">
          <div className='container mx-auto px-4 relative z-10 '>
            <div className='flex flex-col gap-10 md:gap-20'>
              <div className='relative flex flex-col text-center items-center'>
                <h2 className='font-medium w-full max-w-lg'>
              ...
              {submitted ? (
                <div className='flex flex-col items-center gap-5 text-center max-w-xl mx-auto p-6 rounded-lg bg-success/20 dark:bg-white/5'>
                  <div className='flex'>
                    <Icon
                  ...
                  <Link
                    href='/'
                    className='group w-fit text-black font-medium bg-transparent dark:bg-white/20 dark:hover:bg-white rounded-full flex items-center gap-4 py-2 pl-5 pr-2 hover:bg-transparent border border-dark'>
                    <span className='group-hover:translate-x-9 group-hover:dark:text-dark dark:text-white transform transition-transform duration-200 ease-in-out'>
                      Back to home
                    </span>
                    <svg
                      width='32'
                ...
                <form
                  ...
                  className='flex flex-col bg-white dark:bg-dark rounded-2xl p-8 gap-8'>
                  <div className='flex flex-col md:flex md:flex-row gap-6'>
                    <div className='w-full'>
                      <label htmlFor='name'>Your Name</label>
                      <input
                        className='w-full mt-2 rounded-full border px-5 py-3 outline-hidden transition dark:border-white/20 border-dark/20 focus-visible:border-primary'
                        id='name'
                        type='text'
                        name='name'
                        value={formData.name}
                    ...
                    <div className='w-full'>
                      ...
                      <input
                        className='w-full mt-2 rounded-full border px-5 py-3 outline-hidden transition border-dark/20 dark:border-white/20 focus:border-primary'
                        id='email'
                        type='email'
                        name='email'
                  ...
                  <div className='flex flex-col md:flex md:flex-row gap-6'>
                    <div className='w-full'>
                      ...
                      <div className="mt-2">
                        <Select>
                          <SelectTrigger>
                            <SelectValue placeholder="Select your intrest" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectGroup>
